...
class Grid:
    ...
    def write_text(self, surface, text, x, y, font_size, color=(230,230,230)):
        textSize = pygame.font.SysFont("comicsansms", font_size)
        textSurf = textSize.render(text, True, color)
    ...
    def update(self, surface,header, res):
        ...
        self.write_text(surface, header, 235, 25, 25)
        if res is not None:
    ...
    def input_box(self, surface, username, inputRect):
        usernameSize = pygame.font.SysFont("comicsansms", 20)
        usernameSurf = usernameSize.render(username, True, (180, 180, 180))
        pygame.draw.rect(surface, (200,200,200), inputRect, 3)
        if usernameSurf.get_width() > inputRect.w:
            username = username[:-1]
            usernameSurf = usernameSize.render(username, True, (180, 180, 180))
        surface.blit(usernameSurf, (88, 320))
        return self.button(surface, 'ENTER', 160, 380, 120, 50, (0,200,0), (0,255,0))
