...
initiating_window = pg.image.load("/home/rita/Downloads/modified_cover.png") 
x_img = pg.image.load("/home/rita/Downloads/X_modified.png") 
y_img = pg.image.load("/home/rita/Downloads/o_modified.png") 
...
while True:
	for event in pg.event.get():
		if event.type == QUIT:
			pg.quit()
			sys.exit()
		elif event.type is MOUSEBUTTONDOWN and connected:
			x, y = pg.mouse.get_pos()
			send_data = '{}-{}'.format(x,y).encode()
